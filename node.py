# -*- coding: utf-8 -*-
"""
Created on Mon Mar  2 18:53:46 2020
...
def create_keys():
    ...
    if wallet.save_keys():
        ...
        response = {
            ...
            'current_balance': blockchain.get_balance()
        }
...
def broadcast_block():
    ...
    if 'block' not in values:
        response = {
            'message': 'No block data was found.'
        }
        return jsonify(response), 400
    block = values['block']
...
def resolve_conflicts():
    ...
    if replaced:
        ...
        response = {
            'message': 'Chain was not replaced. Local chain kept.'
        }
        return jsonify(response), 200
...
def add_node():
    ...
    if 'node' not in values:
        response = {
            'message': 'No node data was found.'
        }
        return jsonify(response), 400
    node = values['node']
